            ...
            Main_Menu:
                while (true)
                {
                        ...
                        switch (mainOption)
                        {
                                ...
                                if (int.TryParse(Console.ReadLine(), out int BookId)) 
                                {
                                    ...
                                    if (bookToBorrow != null)
                                    {
                                        ...
                                        if (int.TryParse(Console.ReadLine(), out int BorrowerId)) 
                                        {
                                            ...
                                            await bookService.IncreaseBorrowedTimes(bookToBorrow);
                            ...
                            break;
                            case "7":
                                Console.WriteLine("Borrowers who delay the books are the following:");
                            ...
                            break;
                            case "8":
                           var borowers = await borrowerService.GetAllAsync();
                            foreach (var borower in borowers)
                            {
                                Console.WriteLine($"{borower.Name} - {borower}");
                            }
                                break;
                            case "9":
                                Console.WriteLine("Enter the title of book");
